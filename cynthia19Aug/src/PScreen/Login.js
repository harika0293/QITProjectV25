      ...
      .catch((error) => {
        ...
        switch (error.code) {
          ...
          case "auth/user-not-found":
            Alert.alert("User not found. Please check your email or create an account.")
            break;
        ...
        AsyncStorage.setItem('@loggedInUserID:id', user.uid);
          ...
          .then(function (doc) {
            ...
            if(doc.data().role !== 'patient'){
              Alert.alert('You are not authorized to access this app. This app is only for patient.');
            }}
            else{
              var userDict = {
                id: user.uid,
    ...
    <Layout style={styles.Container}>
      <Layout style={styles.headMain}>
        ...
        <Layout style={styles.signin}>
          <Text style={{fontSize: 14, color: '#818181', fontFamily: 'Recoleta-Medium',}}>
            New to Vigilance AI?
          </Text>
          <TouchableOpacity onPress={() => navigation.navigate('OTPScreen')}>
            <Text style={{fontSize: 14, color: '#0075A9', fontFamily: 'Recoleta-Medium',}}>
              {' '}
              Create Your Account
            </Text>
          </TouchableOpacity>
