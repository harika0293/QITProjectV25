    ...
    const patientDetails = [
        {
            ...
            height: patient.height?patient.height:"5'5 inches",
        ...
        <Layout style={styles.Container}>
            ...
            renderItem={({ item }) => {
                return (
                    ...
                    <Text style={{fontSize:16,fontFamily:"GTWalsheimPro-Bold",paddingTop:8}}><Text style={{fontSize:17,fontFamily:"GTWalsheimPro-Bold",color:"grey"}}>DOB : </Text> {item.age}</Text>
                   ...
                   <Divider/>
                    ...
                    <Layout style={styles.personalDetail}>
                    <Text style={{fontSize:16,fontFamily:"GTWalsheimPro-Bold"}}><Text style={{fontSize:17,fontFamily:"GTWalsheimPro-Bold",color:"grey"}}>Email : </Text> {item.address}</Text>
